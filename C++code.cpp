//this implements the same problem of using branch  and bound in C++ language.
#include <bits/stdc++.h>
using namespace std;
const int N = 5; // Number of towns

int final_path[N + 1]; // Stores the final solution path
bool visited[N]; // Keeps track of visited towns
int final_res = INT_MAX; // Stores the final minimum cost
